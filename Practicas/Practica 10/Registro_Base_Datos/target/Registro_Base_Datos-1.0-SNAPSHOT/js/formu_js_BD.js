...
function agregar() {
    ...
    tablaUsuarios = document.getElementById('contenido');
    ...
    ajax.onreadystatechange = function () {
        if (ajax.readyState === 4 || ajax.status === 200) {
            tablaUsuarios.innertHTML = ajax.responseText;
        } else {
            tablaUsuarios.innerHTML = "<img width='50' height='50' src='img/cargando.gif'>";
        }
    }

    ajax.open("POST", "formularioclientesajax");
