<%-- 
    Document   : transferencias_banco
    Created on : 20 ago. 2022, 22:40:24
    Author     : fhuaquisto
--%>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="./css/transferencias_banco.css"/>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Transferencias Banco | ViaBCP</title>
    ...
    <body>
        ...
        <section>
            ...
            <div class="actions">
                ...
                <button class="continuar banco">Continuar</button>
            </div>
        </section>
        <script src="./js/transferencias_banco.js"></script>
    </body>
</html>
