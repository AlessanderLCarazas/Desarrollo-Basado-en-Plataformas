<%-- 
    Document   : cuentas
    Created on : 20 ago. 2022, 19:24:23
    Author     : fhuaquisto
--%>
...
<%
    Account cuenta = (Account)request.getAttribute("cuenta");
%>
        ...
        <div class="box">
            <div class="main">
                <div class="title">
                    ...
                    <button class="boton">Estado de cuenta</button>
                </div>

                <div class="contenedor header">
                    <div>
                        <h2>Saldo disponible</h2>
                        <p>s./ <span><%=cuenta.getSaldo()%></span></p> <!-- AQUI IRIA EL SALDO -->
                    </div>

                    <div>
                        <h2>Numero de cuenta</h2>
                        <span><%=cuenta.getNumero()%></span><!-- Aqui va el numero de cuenta -->
                    </div>
                </div>
                <div class="contenedor transactions">
                    <h2>Últimos movimientos</h2>
                    <div class="movimientos">
                        <div class="header">
                            <h3>Fecha</h3>
                            <h3>Descripción</h3>
                            <h3 class="last">Monto</h3>
                        </div>
                        <%List<Transaction> transacciones = 
                                (List<Transaction>)request.getAttribute("transacciones");
                            for(Transaction s: transacciones){%>
                        <div class="transaction">
                            <span><%=s.getFecha()%></span>
                            <span><%=s.getDescription()%></span>                            
                            <span class="last"><%=s.getMonto()%></span>
                        </div>
                        <%}%>
                    </div>
                </div>
