<%-- 
    Document   : index
    Created on : 20 ago. 2022, 21:19:11
    Author     : fhuaquisto
--%>
...
<%
    if (session.getAttribute("id") != null) {
         response.sendRedirect("/dbp-project/home");
    }
%>
<!DOCTYPE html>
<html>
    <head>
        <title>Login  | ViaBCP</title>
    ...
    <body>
        ...
        <div class="form">
            ...
            <form id="login">
                <p class="error" style="display: none">Error, datos no validos</p>
                <h3>Numero de tarjeta</h3>
                <input name="tarjeta" id="tarjeta" type="number" ondrop="return false;" onpaste="return false;" onkeypress="return event.charCode>=48 && event.charCode<=57" oninput="maxLengthCheck(this,16)" />
                <h3>Clave de internet de 6 digitos</h3>
