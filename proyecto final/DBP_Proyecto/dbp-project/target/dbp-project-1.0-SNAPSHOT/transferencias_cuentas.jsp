<%-- 
    Document   : transferencias_cuentas
    Created on : 20 ago. 2022, 22:40:09
    Author     : fhuaquisto
--%>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="./css/transferencias_cuentas.css"/>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Transferencia Cuenta | ViaBCP</title>
    ...
    <body>
        ...
        <section>
            <div class="title">
                <h2>Transferencia a una cuenta propia</h2>
                <p>Ingresa los datos y completa las opciones para continuar</p>
            </div>
            <form>
                <div class="form">
                    <div class="input">
                    ...
                    <div class="input">
                        <label for="to">Cuenta destino</label>
                        <select id="to">
                            <%
                            for(Account s:std){%>
                                <option value="<%=s.getId()%>"><%=s.getNumero()%></option>
                    ...
                    <div class="group">
                        <div class="input">
                            ...
                            <select id="currency">
                                ...
                                <option value="dolares">USS</option>
                            </select>
                        </div>
                        <div class="input">
            ...
            <div class="box hidden">
                <div class="card">
                    ...
                    <p>Ahorro soles 21512345678912</p>
                </div>
                <div class="card">
                    <h3>Destino</h3>
                ...
                <div class="monto">Monto a transferir S/ 1.00</div>
            </div>
            <div class="actions">
                <button class="volver">Volver</button>
                <button class="continuar cuentas">Continuar</button>
            </div>
        </section>
        
    </body>
    <script src="./js/transferencias_cuentas.js"></script>
</html>
