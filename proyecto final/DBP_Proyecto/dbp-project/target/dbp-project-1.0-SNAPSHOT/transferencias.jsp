<%-- 
    ...
    Created on : 20 ago. 2022, 22:37:51
    Author     : fhuaquisto
--%>
...
<html>
    <head>
        ...
        <title>Tnasferencias | ViaBCP</title>
        ...
        <section>
            <div class="box">
                <div class="title">
                    ...
                    <p>¿Qué tipo de transferencias vas a realizar?</p>
                </div>
                <div class="links">
                    <a href="./transferencias-cuentas">
                        <img src="https://stbcpzonasegura.viabcp.com/assets/img/transfer-own.svg" alt="alt"/>
                        <h3>Entre mis propias cuentas BCP</h3>
                    </a>
                    <a href="./transferencias-banco">
                        <img src="https://stbcpzonasegura.viabcp.com/assets/img/transfer-third.svg" alt="alt"/>
                        <h3>A otras cuentas BCP</h3>
                    </a>
                </div>
                <div class="actions">
